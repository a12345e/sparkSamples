...
@pytest.mark.parametrize("input_row, expected_row", [
    ...
    pytest.param(Row(status="start"), Row(status=find_match_ranges.Status.START.value),
                 id='check enumeration of start status'),
    pytest.param(Row(status="update"), Row(status=find_match_ranges.Status.UPDATE.value),
                 id='check enumeration of update status'),
    pytest.param(Row(status="end"), Row(status=find_match_ranges.Status.END.value),
                 id='check enumeration of end status')])
...
@pytest.mark.parametrize("input_row, expected_rows", [
    pytest.param(Row(a='a', b='b', status=TransactionAnalysis.Status.END.value),
                 [Row(a='a', b='b', status=TransactionAnalysis.Status.END.value)], id='a not null is ok'),
    pytest.param(Row(a=None, b='b', status=TransactionAnalysis.Status.END.value), [],
                 id='a is null is and we chose filter_avoid_null_a_col'),
    pytest.param(Row(a='a', b=None, status=TransactionAnalysis.Status.START.value), [],
                 id='b is null and status=Start row removed'),
    pytest.param(Row(a='a', b='b', status=TransactionAnalysis.Status.START.value),
                 [Row(a='a', b='b', status=TransactionAnalysis.Status.START.value)],
                 id='b is not none and status=Start row not removed'),
    pytest.param(Row(a='a', b=None, status=TransactionAnalysis.Status.END.value),
                 [Row(a='a', b=None, status=TransactionAnalysis.Status.END.value)],
                 id='b is none and status!=start so row not removed'),
    pytest.param(Row(a='a', b='b', status=TransactionAnalysis.Status.START.value),
                 [Row(a='a', b='b', status=TransactionAnalysis.Status.START.value)], id='start status not removed'),
    pytest.param(Row(a='a', b='b', status=TransactionAnalysis.Status.END.value),
                 [Row(a='a', b='b', status=TransactionAnalysis.Status.END.value)], id='end status not removed'),
...
@pytest.mark.parametrize("default_row, input_rows, expected_rows", [
    pytest.param(Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=True)
        , [Row()], [Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=True)],
                 id='one full row with start validation=true is valid'),
    pytest.param(Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=True)
        , [Row(), Row(o2=2)],
                 [Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=False),
                  Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=2, v=False)],
                 id='invalid because two rows for same key (a=1,t=1) with two values for o1 witch is part of the other matches columns'),
    pytest.param(Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=True)
        , [Row(), Row(b=1)],
                 [Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=False),
                  Row(a=0, b=1, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=False)],
                 id='invalid because two rows for same key (a=1,t=1) with b=1 and b=0'),
    pytest.param(Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=True)
        , [Row(), Row(a=1)],
                 [Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=True),
                  Row(a=1, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=True)],
                 id='Valid because values of a in this case are in keys'),
...
@pytest.mark.parametrize("default_row, input_rows, expected_rows", [
    ...
    pytest.param(Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=True)
        , [Row(), Row(o2=2)],
                 [Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=False),
                  Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=2, v=False)],
                 id='invalid because two rows for same key (a=1,t=1) with o1=1 and o1=2'),
    pytest.param(Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=True)
        , [Row(), Row(b=1)],
                 [Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=False),
                  Row(a=0, b=1, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=False)],
    ...
    pytest.param(Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=True)
        , [Row(), Row(a=1)],
                 [Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=False),
                  Row(a=1, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=1, o2=1, v=False)],
                 id='Invalid because two values for a_col'),
    pytest.param(Row(a=0, b=0, status=TransactionAnalysis.Status.START.value, t=1, o1=None, o2=None, v=True)
...
@pytest.mark.parametrize("input_rows, expected_rows", [
    pytest.param(
        ...
        [
            Row(a=0, b=0, status=1, t=1, o1=1, o2=1, v=True, start_time=1,
                ...
                end_reason_name=TransactionAnalysis.EndingTransactionReason.NEXT_END_FOR_SAME_MATCH.name, end_time=2),
    ...
    pytest.param(
        ...
        [
            Row(a=0, b=0, status=3, t=1, o1=1, o2=1, v=False, start_time=None, end_reason_ordinal=None,
                end_reason_name=None, end_time=None),
            Row(a=0, b=0, status=1, t=1, o1=1, o2=1, v=True, start_time=1, end_reason_ordinal=None,
                end_reason_name=None, end_time=None),
    ...
    , pytest.param(
        ...
        [Row(a=0, b=0, status=1, t=1, o1=1, o2=1, v=True, start_time=1, end_reason_ordinal=None, end_reason_name=None),
         Row(a=0, b=0, status=3, t=0, o1=1, o2=1, v=False, start_time=None, end_reason_ordinal=None,
             end_reason_name=None, end_time=None)], id='end time before start time so no transaction'),

    pytest.param(
        [Row(a=0, b=0, status=1, t=1, o1=1, o2=1, v=True),
         Row(a=0, b=1, status=3, t=2, o1=1, o2=1, v=False)],

        [Row(a=0, b=1, status=3, t=2, o1=1, o2=1, v=False, start_time=None, end_reason_ordinal=None,
             end_reason_name=None, end_time=None),
         Row(a=0, b=0, status=1, t=1, o1=1, o2=1, v=True, start_time=1,
    ...
    pytest.param(
        ...
        [Row(a=0, b=0, status=1, t=1, o1=1, o2=1, v=True, start_time=1,
             end_reason_ordinal=TransactionAnalysis.EndingTransactionReason.NEXT_END_NULL.value,
             end_reason_name=TransactionAnalysis.EndingTransactionReason.NEXT_END_NULL.name, end_time=2),
         Row(a=0, b=None, status=3, t=2, o1=1, o2=1, v=False, start_time=None, end_reason_ordinal=None,
             end_reason_name=None, end_time=None)], id='next match null'),
    ...
    pytest.param(
        ...
        [Row(a=0, b=0, status=1, t=1, o1=1, o2=1, v=True, start_time=1,
             end_reason_ordinal=TransactionAnalysis.EndingTransactionReason.NEXT_START_MATCH_BREAK.value,
             end_reason_name=TransactionAnalysis.EndingTransactionReason.NEXT_START_MATCH_BREAK.name, end_time=2),
         Row(a=0, b=1, status=1, t=2, o1=1, o2=1, v=True, start_time=2, end_reason_ordinal=None, end_reason_name=None,
             end_time=None)], id='next start transaction breaking incumbent match'),
    ...
    pytest.param(
        ...
        [Row(a=0, b=0, status=1, t=1, o1=1, o2=1, v=True, start_time=1,
             end_reason_ordinal=TransactionAnalysis.EndingTransactionReason.NEXT_START_MATCH_BREAK.value,
             end_reason_name=TransactionAnalysis.EndingTransactionReason.NEXT_START_MATCH_BREAK.name, end_time=2),
         Row(a=1, b=0, status=1, t=2, o1=1, o2=1, v=True, start_time=2, end_reason_ordinal=None, end_reason_name=None,
             end_time=None)], id='next start match break'),
    ...
    pytest.param(
        ...
        [Row(a=0, b=0, status=1, t=1, o1=1, o2=1, v=True, start_time=1,
             end_reason_ordinal=TransactionAnalysis.EndingTransactionReason.NEXT_START_MATCH_NULL.value,
             end_reason_name=TransactionAnalysis.EndingTransactionReason.NEXT_START_MATCH_NULL.name, end_time=2),
         Row(a=0, b=None, status=1, t=2, o1=1, o2=1, v=True, start_time=2, end_reason_ordinal=None,
             end_reason_name=None, end_time=None)], id='next start match null'),
    ...
    pytest.param(
        ...
        [Row(a=0, b=0, status=1, t=1, o1=1, o2=1, v=True, start_time=1,
         ...
         Row(a=0, b=0, status=1, t=2, o1=1, o2=1, v=True, start_time=2, end_reason_ordinal=None, end_reason_name=None,
             end_time=None)],
...
@pytest.mark.parametrize("input_rows, expected_rows", [
    pytest.param(
        ...
        , id='We take the first end time match break then prefer between end reasons of the same end time.'
             'Notice that end_time=3 is not considered as there is also end time=2 even though it is the highest priority reason in this case'
    ),
...
def test_connect_succeeding_transactions(spark, input_rows, expected_rows):
